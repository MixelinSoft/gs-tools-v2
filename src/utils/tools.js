...
const tools = [
  {
    ...
    toolDescription:
      "Инструмент для калибровки топлива, запрашивает у пользователя номер ёмкости или вид топлива, высоту топлива в выбранной ёмкости в сантиметрах. При нажатии кнопки 'Рассчитать' производятся рассчёты согласно калибровочной таблицы, результат округляется до целых чисел и выводится в литрах. Есть возможность исключить трубопровод из рассчёта объёма. Так-же после выбора ёмкости появляется кнопка 'Информация о резервуаре', при нажатии на которую открывается модальное окно с подробной информацией о резервуаре (Максимальный объём, мёртвый остаток и т.д.) ",
    toolID: "01",
    toolSlug: "calibrate",
    toolVersion: "1.2.4",
    tool: Calibration,
  ...
  },
  {
    ...
    toolDescription:
      "Инструмент для подсчёта заработной платы, запрашивает отработанные часы и проданные литры. Есть возможность изменить почасовую ставку и оплату за литраж. При нажатии на кнопку 'Рассчитать' производится рассчёт. Итоговая сумма округляется до запятой (до целых грн)",
    toolID: "04",
  ...
  },
  {
    ...
    toolDescription: "Инструмент для подсчёта сроков годности товаров",
    toolID: "05",
