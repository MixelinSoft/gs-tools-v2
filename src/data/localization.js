  ...
  ru: {
    ...
    tools: {
      ...
      densityCalc: {
        ...
        description:
          'Инструмент для вычисления объёма/веса/плотности топлива. Запрашивает у пользователя вычисляемую величину, после выбора величины запрашивает объём/плотность/вес, в зависимости от выбора вычисляемой величины. При нажатии на кнопку "Рассчитать" производятся рассчёты, результат выводится с округлением до целых чисел, за исключением плотности - до четырёх знаков после запятой. При некорректном вводе и невозможноси произвести рассчёты пользователь будет оповещён соответствующим уведомлением',
      },
      expirationDate: {
