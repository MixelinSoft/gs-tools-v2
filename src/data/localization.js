  ...
  ru: {
    ...
    tools: {
      ...
      phoneBook: {
        ...
        description:
          'Справочник, с номерами АЗС, названиями предприятий, районами, почтовыми индексами, адресами и миникартой. При нажатии на номер телефона открывается приложение для звонков с набранным номером выбранной АЗС. При нажатии на мини-карту открывается приложение "Google Maps", если установлено на устройстве, в противном случае открывается веб версия, с установленой точкой координат на выбранной АЗС. Под картой находятся кнопка "Копировать" - при нажатии копирует данные в буфер обмена, и кнопка "Поделиться" (Отображается не во всех браузерах) - при нажатии предлагает пользователю поделиться информацией в доступных мессенджерах.',
        sharingText: {
          btnCopy: 'Копировать',
          btnShare: 'Поделиться',
          address: 'адрес',
